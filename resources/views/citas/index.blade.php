...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="agregarCita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="{{ route('reservas.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descripcion" id="desc" rows="3" required></textarea>
                        </div>
                        <br>
                        <div class="form-group">
